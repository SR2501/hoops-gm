...
- [x] **done** - Populated `2025-12-08..2026-01-04`: 171 games across 25 dates/all 30 teams and both report regimes, all five statuses, 1,906 stable-NBA-id participation joins, 27 canonical unresolved identities, one explicitly unknown R35 participation gap, and source-observed G/F/C evidence. Scope was frozen from the official schedule before the sweep; no rate was fit. Evidence: `docs/adapters/nba-injury-report-cohort-2025-12-08--2026-01-04.json`. Independently data/evidence- and code-reviewed at `4e89cc5f59c31656508183a2939a82d03a92ec1a`.

...
- **Schedule** — `team_schedule`, `schedule_density` (B2B, 3-in-4, 4-in-6, rest diff), `week_definitions`, `off_night_slates`, `opponent_context` (pace, category defence, blowout risk)
